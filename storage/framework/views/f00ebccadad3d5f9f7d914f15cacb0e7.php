...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catygory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($product->id); ?></td>
                <td><img src="<?php echo e(asset('img/' . $category->name . '/' . $product->img_name)); ?>" class="img-list" /></td>
                <td><?php echo e($product->products_name); ?></td>
                
                <td><?php echo e($product->products_price); ?>$</td>
                <td>
...
<?php /**PATH C:\wamp64\www\my_aoo\resources\views/index7.blade.php ENDPATH**/ ?>