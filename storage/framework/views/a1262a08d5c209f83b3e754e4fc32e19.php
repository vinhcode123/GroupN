...
<head>
    ...
    <link href="<?php echo e(asset('css/jquery.smartmenus.bootstrap.css')); ?>" rel="stylesheet" />
    <!-- Product view slider -->
...
<body>
                            ...
                            <div class="aa-cartbox">
                                ...
                                <div class="aa-cartbox-summary">
                                    ...
                                    <a class="aa-cartbox-checkout aa-primary-btn"
                                        href="<?php echo e(route('checkout')); ?>">Checkout</a>
                                </div>
                            </div>
                            <!-- / cart box -->
                            <!-- search box -->
                ...
                <div class="navbar navbar-default" role="navigation">
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="<?php echo e(route('blog1')); ?>">Blog <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                        ...
                        <div class="aa-product-area">
                            <div class="aa-product-inner">
                                ...
                                <div class="tab-content">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="tab-pane fade <?php echo e($loop->first ? 'in active' : ''); ?>"
                                                    ...
                                                    <li>
                                                        <figure>
                                                            <a class="aa-product-img" href="#">
                                                                <img src="<?php echo e(asset('img/' . $category->name . '/' . $product->img_name)); ?>"
                                                                    alt="<?php echo e($product->products_name); ?>">
                                                            </a>
                                                            <form action="cart" method="post">
                                                            <a class="aa-add-card-btn" href="<?php echo e(route('getcart',$product ->id)); ?>">
                                                            ...
                                                            <figcaption>
                                                                <h4 class="aa-product-title">
                                                                    <a
                                                                        href="#"><?php echo e($product->products_name); ?></a>
                                                                </h4>
                                                                <span
                                                                    class="aa-product-price"><?php echo e($product->products_price); ?>$</span>
                                                            </figcaption>
                                                        </figure>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/jquery.smartmenus.js')); ?>"></script>
    <!-- SmartMenus jQuery Bootstrap Addon -->
    <script type="text/javascript" src="<?php echo e(asset('js/jquery.smartmenus.bootstrap.js')); ?>"></script>
    <!-- To Slider JS -->
    <script src="<?php echo e(asset('js/sequence.js')); ?>"></script>
    <script src="<?php echo e(asset('js/sequence-theme.modern-slide-in.js')); ?>"></script>
    <!-- Product view slider -->
    ...
    <!-- Price picker slider -->
    <script type="text/javascript" src="<?php echo e(asset('js/nouislider.js')); ?>"></script>
    <!-- Custom js -->
...
<?php echo $__env->make('auth.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\my_aoo\resources\views/index.blade.php ENDPATH**/ ?>