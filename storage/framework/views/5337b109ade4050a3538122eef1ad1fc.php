            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li><a href="<?php echo e(route('login')); ?>" data-toggle="modal" data-target="#login-modal">Login</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <a class="aa-cartbox-checkout aa-primary-btn" href="<?php echo e(route('checkout')); ?>">Checkout</a>
                </div>
              </div>
              <!-- / cart box -->
              <!-- search box -->
...
<?php echo $__env->make('auth.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\DoanBe2-Ver1.0\my_aoo\resources\views/product.blade.php ENDPATH**/ ?>