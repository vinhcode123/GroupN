        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <form class="aa-login-form" action="">
            ...
            <div class="aa-register-now">
              Don't have an account?<a href="<?php echo e(route('account')); ?>">Register now!</a>
            </div>
          </form>
        </div>                        
      </div><!-- /.modal-content -->
...
</html><?php /**PATH C:\wamp64\www\DoanBe2\my_aoo\resources\views/product-detail.blade.php ENDPATH**/ ?>