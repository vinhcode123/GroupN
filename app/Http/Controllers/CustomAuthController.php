...
class CustomAuthController extends Controller
{
   ...
   //dd($products);
    ...
    public function indexUser()
    {
        ...
        return view('index', compact('categories'),['categories' => $categories]);
    }
    ...
    public function wishlist()
    {
     ...
     public function index5(){
        ...
        dd($products);
            return view('index5',['products'=>$products]);
     }
     public function index6(){
        $products = Products::all();

        dd($products);
            return view('index6',['products'=>$products]);
     }
     public function index7(){
        ...
        return view('index7', compact('categories'),['categories' => $categories]);
     }
}
